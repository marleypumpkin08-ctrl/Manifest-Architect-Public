...
class AppIDPage(Gtk.Box):
    def __init__(self, window):
        ...
        self._compat_tool_combo.add_prefix(icon)
        if hasattr(self._compat_tool_combo, 'set_enable_arrow'):
            self._compat_tool_combo.set_enable_arrow(True)
        self._compat_tool_combo.set_visible(False)

        self._compat_model = Gtk.StringList.new(['Native Steam'])
        self._compat_tool_combo.set_model(self._compat_model)
    ...
    def _populate_compat_tools(self):
        ...
        items = ['Native Steam'] + tools
        self._compat_model = Gtk.StringList.new(items)
        self._compat_tool_combo.set_model(self._compat_model)
...
class ManifestStudioApp(Adw.Application):
    def __init__(self):
        super().__init__(application_id='com.manifeststudio.app')
